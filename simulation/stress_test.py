...
def build_simulation_bundle(
    ...
    synthetic_specs = [
        ...
        {
            "id": "svb_weekend_bank_run",
            "title": f"{asset_symbol}/{base_symbol} weekend redemption panic",
            "description": "A confidence shock triggers rushed exits into thin weekend liquidity, then partially recovers once redemptions reopen.",
            "tagline": "Confidence shock first, balance-sheet clarity later.",
            "risk_focus": "Weekend liquidity and redemption panic",
            "event_window_label": "Scenario lab: weekend bank run",
            "kind": "scenario_lab",
            "seed": 1203,
            "periods": 44,
            "peg_targets": [-0.002, -0.012, -0.039, -0.052, -0.021],
            "peg_lengths": [8, 8, 10, 8, 10],
            "sol_multipliers": [1.0, 0.99, 0.955, 0.948, 0.972],
            "sol_lengths": [8, 8, 10, 8, 10],
            "highlights": [
                "Designed to mimic a weekend confidence spiral where liquidity vanishes before fundamentals settle.",
                "Static policy keeps lending into the worst part of the panic because the recovery comes too late.",
                "PegShield only needs a few intervals of tightening to materially cut the bad-debt window.",
            ],
        },
        {
            "id": "stablecoin_redemption_spiral",
            "title": f"{asset_symbol}/{base_symbol} redemption spiral",
            "description": "A collateral-side discount feeds a wider market selloff, then the peg stabilizes only after forced deleveraging has already propagated.",
            "tagline": "Discount begets liquidations, liquidations beget more discount.",
            "risk_focus": "Reflexive liquidation spiral",
            "event_window_label": "Scenario lab: redemption spiral",
            "kind": "scenario_lab",
            "seed": 1447,
            "periods": 46,
            "peg_targets": [-0.004, -0.015, -0.028, -0.061, -0.074, -0.036],
            "peg_lengths": [8, 8, 8, 8, 6, 8],
            "sol_multipliers": [0.998, 0.99, 0.972, 0.93, 0.905, 0.94],
            "sol_lengths": [8, 8, 8, 8, 6, 8],
            "highlights": [
        ...
        {
            "id": "restaking_bridge_contagion",
            "title": f"{asset_symbol}/{base_symbol} bridge contagion unwind",
            "description": "Cross-venue stress leaks into the peg, correlation spikes, and a restaking narrative unwind keeps the asset impaired longer than usual.",
            "tagline": "Contagion spreads across venues before the peg can normalize.",
            "risk_focus": "Cross-venue contagion",
            "event_window_label": "Scenario lab: bridge contagion",
            "kind": "scenario_lab",
            "seed": 2008,
            "periods": 52,
            "peg_targets": [-0.003, -0.011, -0.022, -0.048, -0.057, -0.051, -0.024],
            "peg_lengths": [8, 8, 8, 8, 8, 6, 6],
            "sol_multipliers": [1.0, 0.994, 0.982, 0.956, 0.938, 0.945, 0.964],
            "sol_lengths": [8, 8, 8, 8, 8, 6, 6],
            "highlights": [
                "Models slower healing even after the initial liquidity event has passed.",
                "Shows why a risk oracle needs persistence, not just a fast twitch response.",
                "The recovery is real, but not fast enough to justify restoring fixed-policy leverage immediately.",
            ],
        },
    ]
