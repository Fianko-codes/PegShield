...
If you want the on-chain counterpart instead of this script-level example, see PegShield Gate in [`solana-program/programs/mock-lender`](../../solana-program/programs/mock-lender).
